...
class JetMail
{
    ...
    public function send($data)
    {
        ...
        $html = '<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width; initial-scale=1.0; maximum-scale=1.0;"><title></title><style type="text/css">div, p, a, li, td { -webkit-text-size-adjust:none; }*{-webkit-font-smoothing: antialiased;-moz-osx-font-smoothing: grayscale;}.ReadMsgBody{width: 100%; background-color: #ffffff;}.ExternalClass{width: 100%; background-color: #ffffff;}body{width: 100%; height: 100%; background-color: #ffffff; margin:0; padding:0; -webkit-font-smoothing: antialiased;}html{width: 100%; background-color: #ffffff;}p {padding: 0!important; margin-top: 0!important; margin-right: 0!important; margin-bottom: 0!important; margin-left: 0!important; }.hover:hover {opacity:0.85;filter:alpha(opacity=85);}.image77 img {width: 77px; height: auto;}.avatar125 img {width: 125px; height: auto;}.icon61 img {width: 61px; height: auto;}.logo img {width: 251px; height: auto;}.icon18 img {width: 18px; height: auto;}</style><!-- @media only screen and (max-width: 640px)
                ...
                <tr>
                    <td width="100%" align="center">
                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full2" object="drag-module-small" style="-webkit-border-bottom-left-radius: 5px; -moz-border-bottom-left-radius: 5px; border-bottom-left-radius: 5px; -webkit-border-bottom-right-radius: 5px; -moz-border-bottom-right-radius: 5px; border-bottom-right-radius: 5px;">
                            <tr>
                                <td width="600" align="center" style="border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; background-color: rgb(255, 255, 255);" bgcolor="#ffffff">
                                    ...
                                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" bgcolor="#ffffff"object="drag-module-small" style="background-color: rgb(255, 255, 255);">
                                        <tr>
                                            <td width="600" valign="middle" align="center">
                                                ...
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="middle" width="100%" style="padding: 30px 0; text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <span style="font-size: 20px;">Hi ' . $first_name . ' ' . $last_name . '!</span>
                                                            <br><br>
                                                            Thank you for signing up with Blurbes.
                                                            <br>
                                                            Your account is currently pending approval but it won’t stop you from benefitting from it.
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <table cellspacing="0" cellpadding="0" align="center" class="mobile2" bgcolor="#ffffff"object="drag-module-small" style="background-color: rgb(255, 255, 255);Margin: auto;">
                                                                <tr>
                                                                    <td align="center" width="240" height="45" bgcolor="#00b0ed" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                                                                        <a href="#" style="font-size:16px; font-weight: bold; font-family:sans-serif; text-decoration: none; line-height:45px; width:100%; display:inline-block">
                                                    ...
                                                    <tr>
                                                        <td valign="middle" width="100%" style="padding: 30px 0; text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <hr><br>
                                                            <span style="font-size: 18px;font-weight: bold;">Benefits of merchant dashboard</span>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="600" valign="middle" align="center" style="padding-bottom: 45px;">
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 75px;" width="75" src="http://www.blurbes.com/edm/misc/macbook-create-blurb.png">
                                                            <br><p style="padding:0 15px!important;">Create and customize your own mobile coupons campaign.</p>
                                                        </td>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 75px;" width="75" src="http://www.blurbes.com/edm/misc/iphone-discount.png">
                                                            <br><p style="padding:0 15px!important;">Distribute your mobile coupons through our Blurbes app.</p>
                                                        </td>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 75px;" width="75" src="http://www.blurbes.com/edm/misc/macbook-analytics.png">
                                                            <br><p style="padding:0 15px!important;">Monitor campaign performance and optimize your next.</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" bgcolor="#e6f7fe" object="drag-module-small" style="padding: 10px 0; border-bottom-left-radius: 5px; border-bottom-right-radius: 5px; background-color:#e6f7fe;">
                                        <tr>
                                            <td width="600" valign="middle" align="center">
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;padding:30px;" >
                                                            <span style="font-weight: bold;">Rewards for your early participation</span>
                                                            <br>
                                                            Free full access to Blurbes till March 2017*.<br>Play a part in shaping this product for you and your customers as we will take your feedback seriously.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" bgcolor="#ffffff"object="drag-module-small" style="background-color: rgb(255, 255, 255);">
                                        <tr>
                                            <td width="600" valign="middle" align="center" style="padding-top: 40px;">
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="middle" width="100%" style="padding-bottom: 30px; text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                        ...
                                        <tr>
                                            <td width="600" valign="middle" align="center">
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 50px;" width="50" src="http://www.blurbes.com/edm/misc/update-profile.png">
                                                            <br><p style="padding:0 15px!important;">Update your profile</p>
                                                        </td>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 50px;" width="50" src="http://www.blurbes.com/edm/misc/create-campaign.png">
                                                            <br><p style="padding:0 15px!important;">Create your campaign</p>
                                                        </td>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 50px;" width="50" src="http://www.blurbes.com/edm/misc/submit-approval.png">
                                                            <br><p style="padding:0 15px!important;">Submit for approval</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                ...
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="middle" width="100%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            Once approved, your campaign will be featured on our Blurbes app.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="600" valign="middle" align="center" style="padding-bottom:35px;">
                                                <table width="540" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                                                    <tr>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 50px;" width="50" src="http://www.blurbes.com/edm/misc/faq.png">
                                                            <br><p style="padding:0 15px!important;">Tutorial and FAQ</p>
                                                        </td>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 50px;" width="50" src="http://www.blurbes.com/edm/misc/message.png">
                                                            <br><p style="padding:0 15px!important;">Email<br>(<a style="color:#00b0ed; text-decoration: none;" href="mailto:info@blurbes.com">info@Blurbes.com</a>)</p>
                                                        </td>
                                                        <td valign="top" width="33%" style="text-align: center; font-family: Helvetica, Arial, sans-serif; font-size: 14px; color: rgb(63, 67, 69); line-height: 24px;" >
                                                            <img style="max-width: 50px;" width="50" src="http://www.blurbes.com/edm/misc/clock.png">
                                                            <br><p style="padding:0 15px!important;">Operating Hours<br>(9am to 8pm)</p>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile2" object="drag-module-small">
                            <tr>
                                <td valign="middle" width="600" style="text-align: left; font-family: Helvetica, Arial, sans-serif; font-size: 13px; color: rgb(0, 0, 0); line-height: 24px; font-style: italic;" >
                                    * Your marketing campaigns must be effective from 18th Oct as our Blurbes app will be launched on that day.
                                </td>
                            </tr>
                        </table>
