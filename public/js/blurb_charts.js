jQuery(document).ready(function(){
    ...
    var ticks = [];
	$.get('/blurb/getLastSevenDays/'+$("#blurb_id").val()+'/snapshot_likes', function(data){
	...
	$.get('/blurb/getLastSevenDays/'+$("#blurb_id").val()+'/snapshot_uviews', function(data){
	...
	$.get('/blurb/getLastSevenDays/'+$("#blurb_id").val()+'/snapshot_usage', function(data){
