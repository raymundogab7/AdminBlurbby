jQuery(document).ready(function(){
    ...
    var ticks = [];
	$.get('/dashboard/getLastSevenDays/snapshot_likes', function(data){
	...
	$.get('/dashboard/getLastSevenDays/snapshot_uviews', function(data){
	...
	$.get('/dashboard/getLastSevenDays/snapshot_usage', function(data){
