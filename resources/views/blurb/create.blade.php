                        ...
                        <div class="tab-content nopadding noborder">
							...
							<input type="hidden" value="{{csrf_token()}}" name="_token">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="input-group">
											{!! Form::text('blurb_start', null, ['required' => 'required', 'id' => 'datepicker', 'placeholder' => 'YYYY-MM-DD', 'class' => 'form-control']) !!}
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<div class="input-group">
											{!! Form::text('blurb_end', null, ['required' => 'required' ,'id' => 'datepicker2', 'placeholder' => 'YYYY-MM-DD', 'class' => 'form-control blurb_end_keyup']) !!}
											<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
										</div><!-- input-group -->
									</div>
								</div><!-- form-group -->
