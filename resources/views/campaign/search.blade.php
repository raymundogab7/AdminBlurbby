	                ...
	                <div class="row">
	                    <div class="col-sm-3">
	                        ...
	                        <ul class="nav nav-pills nav-stacked nav-contacts">
	                            ...
	                            <li class="@if(strpos(url()->current(), 'live')) active @endif">
	                            ...
	                            <li class="@if(strpos(url()->current(), 'rejected')) active @endif">
	                            ...
	                            <li class="@if(strpos(url()->current(), 'pending-approval')) active @endif">
	                            ...
	                            <li class="@if(strpos(url()->current(), 'draft')) active @endif">
	                            ...
	                            <li class="@if(strpos(url()->current(), 'expired')) active @endif">
	                            ...
	                            <a href="{{url('campaigns/'.$campaign->campaignId)}}" class="list-group-item">
	                                <div class="media">
	                                    <div class="pull-left">
	                                    	...
	                                    	<img class="img-roundedcircle img-online" src="{{env('MERCHANT_URL').'/'.$campaign->res_logo}}" alt="...">
	                                    	@else
