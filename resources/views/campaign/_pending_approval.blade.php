...
<div class="col-sm-12 col-md-8 col-xs-12" style="padding-bottom:20px;">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <input type="text" disabled="" value="{{$campaign['restaurants']['res_name']}}" class="form-control">
            {!! Form::hidden('restaurant_id', $campaign['restaurant_id'], ['readonly' => 'readonly', 'class' => 'form-control']) !!}
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            {!! Form::text('campaign_name', $campaign['campaign_name'], ['readonly' => 'readonly','required' => 'required', 'class' => 'form-control']) !!}
        </div>
    </div><!-- form-group -->
