<div class="leftpanel">
    ...
    <ul class="nav nav-pills nav-stacked">
        ...
        <li class="@if(strpos(url()->current(), 'app-users')) active @endif"><a href="{{url('app-users')}}"><span class="pull-right badge">@if($app_user_count = \Admin\AppUser::where('status', 'Pending Email Verification')->count()) {{$app_user_count}} @endif</span><i class="fa fa-user"></i> <span>App Users</span></a></li>
        <li class="@if(strpos(url()->current(), 'blurb-reports')) active @endif"><a href="{{url('blurb-reports')}}"><span class="pull-right badge">@if($notified_count = \Admin\BlurbReport::where('notified', 0)->count()) {{$notified_count}} @endif</span><i class="fa fa-exclamation-circle"></i> <span>Blurb Reports</span></a></li>
