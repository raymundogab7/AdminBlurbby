                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-8 col-xs-12">
                        <div class="tab-content nopadding noborder">
							...
							@include('merchants.blurb._approved', ['blurb' => $blurb])
                            @elseif($blurb->blurb_status == 'Pending Approval')
                            @include('merchants.blurb._pending_approval', ['blurb' => $blurb])
                            @elseif($blurb->blurb_status == 'Created')
                            @include('merchants.blurb._draft', ['blurb' => $blurb])
                            @elseif($blurb->blurb_status == 'Rejected')
                            @include('merchants.blurb._rejected', ['blurb' => $blurb])
                            @elseif($blurb->blurb_status == 'Live')
                            @include('merchants.blurb._live', ['blurb' => $blurb])
                            @elseif($blurb->blurb_status == 'Expired')
                            @include('merchants.blurb._expired', ['blurb' => $blurb])
                            @endif
						</div><!-- tab-content -->
                    </div><!-- col-sm-9 -->
                </div><!-- row -->
