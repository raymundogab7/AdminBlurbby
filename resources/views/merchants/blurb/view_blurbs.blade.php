                        ...
                        <table id="view_blurbs" class="table table-striped table-bordered responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{url('blurb/'.$blurb['id'].'/'.$campaign['control_no'].'/result')}}">{{$blurb['blurb_name']}}</a></td>
                                    <td>
                                    ...
                                    @if($blurb['blurb_status'] == 'Rejected' || $blurb['blurb_status'] == 'Created')
                                        ...
                                        <a href="{{url('blurb/'.$blurb['id'].'/'.$campaign['control_no'].'/result')}}" data-toggle="tooltip" title="Edit" class="tooltips"><i class="fa fa-pencil"></i></a>
                                    ...
                                    @else
                                        ...
                                        <a href="{{url('blurb/'.$blurb['id'].'/'.$campaign->control_no.'/result')}}" data-toggle="tooltip" title="View" class="tooltips"><i class="fa fa-eye"></i></a>
                                    @endif
