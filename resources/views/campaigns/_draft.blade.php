	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<div class="input-group">
                ...
                {!! Form::text('cam_start', date_format(date_create($campaign['cam_start']), 'Y-m-d'), ['readonly' => 'readonly', 'required' => 'required', 'id' => 'datepicker', 'placeholder' => 'YYYY-MM-DD', 'class' => 'form-control']) !!}
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<div class="input-group">
                ...
                {!! Form::text('cam_end', date_format(date_create($campaign['cam_end']), 'Y-m-d'), ['readonly' => 'readonly', 'required' => 'required' ,'id' => 'datepicker2', 'placeholder' => 'YYYY-MM-DD', 'class' => 'form-control']) !!}
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
            </div><!-- input-group -->
		</div>
	</div><!-- form-group -->
